...
define([
    ...
    var notesHistoryList = declare('Sage.UI.NotesHistoryList', [_Widget], {
        ...
        startup: function () {
            ...
            var helpToolTip = (this.options.includeAttendees) ? notesHistoryListStrings.helpText : notesHistoryListStrings.helpText + ' *';
            var toolConfig = [
                {
                    id: 'SendEmail',
        ...
        onSendToWordClick: function () {
            ...
            var getWordApplication = function () {
                if (typeof slx !== 'undefined' && slx && slx.com) {
                    // slx.com - this is prefered, if available, because it will bypass the security dialog
                    try {
                        return slx.com.create("Word.Application");
