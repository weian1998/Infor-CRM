        ...
        _completeActivity: function (completedDate) {
            ...
            */
            if (this.mode === 'Complete') {
                ...
                //When the leader is changed it does not populate the userId and name of the history. 
                utility.setValue(this._activityData, 'UserId', this._activityData.Leader.$key);
                utility.setValue(this._activityData, 'UserName', this._activityData.Leader.$descriptor);
