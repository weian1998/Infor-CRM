...
<project path="" name="SagePlatform" author="SalesLogix, N.A., LLC." version="8.0.0" copyright="" output="$project\sage-platform" source="False" source-dir="$output\source" minify="False" min-dir="$output\docs" doc="False" doc-dir="$output\docs" master="true" master-file="$output\yui-ext.js" zip="true" zip-file="$output\yuo-ext.$version.zip">
