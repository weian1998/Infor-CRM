...
{ AccessError: 'Votre rôle ne vous permet pas d\'exécuter cette action.',
  AddFolderError: 'Une erreur inattendue est survenue lors de la tentative d\'ajout d\'un dossier de bibliothèque.',
  Cancel: 'Annuler',
  Confirm: 'Confirmer',
  DeleteFolderCnfmFmt: 'Voulez-vous vraiment supprimer le dossier "${0}" et tout ce qu\'il contient ?',
  DeleteFolderError: 'Une erreur inattendue est survenue lors de la tentative de suppression d\'un dossier de bibliothèque.',
  ...
  RenameFolderError: 'Une erreur inattendue est survenue lors du changement de nom d\'un dossier de bibliothèque.',
  Yes: 'Oui' }
));