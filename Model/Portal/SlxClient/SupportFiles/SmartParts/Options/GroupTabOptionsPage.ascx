    ...
    <tr>
        ...
        <td>
            <table border="0" cellpadding="1" cellspacing="0" class="formtable" style="margin-top:0px">
                <tr>
                    <td class="highlightedCell" style="padding:0">
                ...
                <tr>
                    <td class="grid-options">
                        <asp:CheckBox runat="server" ID="cbAutoFitColumns" Text="Auto-fit Columns" meta:resourcekey="cbAutoFitColumnsResource1" CssClass="option-check inforAspCheckBox" />
                        <br />
