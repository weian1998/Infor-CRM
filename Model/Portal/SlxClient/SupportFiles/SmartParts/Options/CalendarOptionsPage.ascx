...
<table border="0" cellpadding="1" cellspacing="0" class="formtable" style="margin-top: 0px;">
    ...
    <tr>
        <td colspan="2">
            ...
            <span class="twocolremainder">
                <span class="lblright">
                <asp:CheckBox ID="chkSun" runat="server" Text="<%$ resources:chkSun.Caption %>" CssClass="inforAspCheckBox" />
                </span>
                <br />
                <span class="lblright">
                    <asp:CheckBox ID="chkMon" runat="server" Text="<%$ resources:chkMon.Caption %>" CssClass="inforAspCheckBox" />
                </span>
                <br />
                <span class="lblright">
                    <asp:CheckBox ID="chkTue" runat="server" Text="<%$ resources:chkTue.Caption %>" CssClass="inforAspCheckBox" />
                </span>
                <br />
                <span class="lblright">
                    <asp:CheckBox ID="chkWed" runat="server" Text="<%$ resources:chkWed.Caption %>" CssClass="inforAspCheckBox" />
                </span>
                <br />
                <span class="lblright">
                    <asp:CheckBox ID="chkThu" runat="server" Text="<%$ resources:chkThu.Caption %>" CssClass="inforAspCheckBox" />
                </span>
                <br />
                <span class="lblright">
                    <asp:CheckBox ID="chkFri" runat="server" Text="<%$ resources:chkFri.Caption %>" CssClass="inforAspCheckBox" />
                </span>
                <br />
                <span class="lblright">
                    <asp:CheckBox ID="chkSat" runat="server" Text="<%$ resources:chkSat.Caption %>" CssClass="inforAspCheckBox" />
                </span>
            </span>
        </td>
    </tr>
