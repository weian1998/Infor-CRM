...
public partial class SmartParts_Campaign_AddEditTask : EntityBoundSmartPartInfoProvider
{
    ...
    private void ResolveOwner(ICampaignTask task)
    {
        ...
        string ownerType = Request.Form[string.Concat("ctl00$", txtOwnerType.ClientID.Replace("_", "$"))];
        ...
        switch (ownerType)
        {
            case "0":
                ...
                ownerName = Request.Form[string.Concat("ctl00$", Id.Replace("_", "$"))];
                break;
            case "1":
            ...
            case "2":
                ...
                break;
            case "3":
                ownerName = Request.Form[string.Concat("ctl00$", txtOther.ClientID.Replace("_", "$"))];
                break;
            case "4":
                ownerName = "";
                break;
    ...
    {
        var service = ApplicationContext.Current.Services.Get<IUserService>() as SLXUserService;
