...
<div runat="server" id="divLookupTargets">
    <table border="0" class="Bevel ExtendWidth">
        <col width="17%" /> 
        <col width="32%" />
        <col width="2%" />
        <col width="17%" />
        ...
        <tr id="row3">
            <td id="row3col1">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkCompany" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkCompany.Caption %>" />
                </div>
            </td>
            <td id="row3col2">
            ...
            <td id="row3col4">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkCity" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkCity.Caption %>" />
                </div>
            </td>
            <td id="row3col5">
                <div class="textcontrol select">
        ...
        <tr id="row4">
            <td id="row4col1">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkIndustry" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkIndustry.Caption %>" />
                </div>
            </td>
            <td id="row4col2">
                <div class="textcontrol select">
            ...
            <td id="row4col4">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkState" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkState.Caption %>" />
                </div>
            </td>
            <td id="row4col5">
                <div class="textcontrol select">
        ...
        <tr id="row5">
            <td id="row5col1">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkSIC" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkSIC.Caption %>" />
                </div>
            </td>
            <td id="row5col2">
                <div class="textcontrol select">
            ...
            <td id="row5col4">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkZip" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkZip.Caption %>" />
                </div>
            </td>
            <td id="row5col5">
                <div class="textcontrol select">
        ...
        <tr id="row6">
            <td id="row6col1">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkTitle" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkTitle.Caption %>" />
                </div>
            </td>
            <td id="row6col2">
                <div class="textcontrol select">
            ...
            <td id="row6col4">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkLeadSource" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkLeadSource.Caption %>" />
                </div>
            </td>
            <td id="row6col5">
                <div class="textcontrol select">
        ...
        <tr id="row7">
            <td id="row7col1">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkProducts" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkProducts.Caption %>" />
                </div>
            </td>
            <td id="row7col2">
            ...
            <td id="row7col4">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkImportSource" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkImportSource.Caption %>" />
                </div>
            </td>
            <td id="row7col5">
                <div class="textcontrol select">
        ...
        <tr id="row8">
            <td id="row8col1">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkStatus" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkStatus.Caption %>" />
                </div>
            </td>
            <td id="row8col2">
                <div class="textcontrol select">
            ...
            <td id="row8col4">
                <div class="slxlabel alignleft">
                    <asp:CheckBox runat="server" ID="chkCreateDate" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkCreateDate.Caption %>" />
                </div>
            </td>
            <td id="row8col5">
                <div class="textcontrol datepicker" style="width:40%;margin-right:10px;">
                    <SalesLogix:DateTimePicker runat="server" ID="dtpCreateFromDate" DisplayTime="true"></SalesLogix:DateTimePicker>               
                </div>
                <div class="lbl" style="width:2%">
        ...
        <tr id="row9">
            ...
            <td id="row9col2" colspan="5">
                <asp:CheckBox runat="server" ID="chkSolicit" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkSolicit.Caption %>" />
                <asp:CheckBox runat="server" ID="chkEmail" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkEmail.Caption %>" />
                <asp:CheckBox runat="server" ID="chkCall" CssClass="checkbox inforAspCheckBox" Text="<%$ resources: chkCall.Caption %>" />
                <asp:CheckBox runat="server" ID="chkMail" CssClass="checkbox  inforAspCheckBox" Text="<%$ resources: chkMail.Caption %>" />
                <asp:CheckBox runat="server" ID="chkFax" CssClass="checkbox  inforAspCheckBox" Text="<%$ resources: chkFax.Caption %>" />
            </td>
        </tr>
        <tr id="row11">
            <td id="row11col1"></td>
