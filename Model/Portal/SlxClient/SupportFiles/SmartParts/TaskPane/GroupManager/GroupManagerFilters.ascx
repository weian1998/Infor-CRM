<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupManagerFilters.cs" Inherits="SmartParts_TaskPane_GroupManagerFilters" %>

<div dojoType="Sage.UI.Filters.FilterPanel" id="PrimaryFilters" configurationProviderType="Sage.MainView.GroupMgr.FilterConfigurationProvider"></div>
