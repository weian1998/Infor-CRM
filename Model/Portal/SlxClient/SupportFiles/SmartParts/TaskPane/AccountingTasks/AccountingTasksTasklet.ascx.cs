    ...
    private void LoadAccountTasks(EntityPage page)
    {
        ...
        if (page.IsDetailMode)
        {
            ...
            if (integrated)
            {
                ...
                {
                    bool restrict = BusinessRuleHelper.RestrictToSingleAccountingSystem(account.AppId);
                    ...
                    lblLinkAccount.Visible = canPromote && !(restrict);
                    imgLinkAccount.Visible = canPromote && !(restrict);
                }
                else
                {
