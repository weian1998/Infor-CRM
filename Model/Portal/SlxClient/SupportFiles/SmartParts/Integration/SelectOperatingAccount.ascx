...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
    ...
    <tr runat="server" id="rowAccountingFeeds">
        ...
        <td colspan="2">
            <asp:ListBox ID="lbxSystems" runat="server" CssClass="select-control" shouldPublishMarkDirty="false" SelectionMode="Single" Rows="1" EnableViewState="true" Width="80%"></asp:ListBox>
        </td>
        <td>
            <br />
        </td>
