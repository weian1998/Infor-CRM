...
<table cellpadding="2" cellspacing="0" class="tbodylt" style="width:345; height:245">
    <tr>
        <td class="alignleft"><asp:Localize ID="localizeFieldName" runat="server" Text="<%$ resources: localizeFieldName.Text %>" /></td>
        <td class="borderr" align="left">
            <input type="text" id="txtFieldName_AddCondition" name="txtFieldName_AddCondition" style="width:150px" />
        </td>
    </tr>
    <tr>
        <td class="alignleft"><asp:Localize ID="localizeFieldType" runat="server" Text="<%$ resources: localizeFieldType.Text %>" /></td>
        <td class="borderr" align="left">
            <input type="text"  id="txtFieldType" name="txtFieldType" style="width:150px">
        </td>
    </tr>
    <tr>
        <td class="alignleft"><asp:Localize ID="localizeOperator" runat="server" Text="<%$ resources: localizeOperator.Text %>" /></td>
        <td class="borderr textcontrol" align="left" id="operatorSpace">
        </td>
        <td align="center"></td>
    </tr>
    <tr>
        <td class="alignleft"><asp:Localize ID="localizeValueIs" runat="server" Text="<%$ resources: localizeValueIs.Text %>" /></td>
        <td class="borderr" align="left">
    ...
    <tr>
        <td>&nbsp;</td>
        <td class="borderr" align="left">
            <input type="checkbox" name="chkCaseSensEdit" id="chkCaseSensEdit" class="inforCheckbox" checked />
            <label for="chkCaseSens" class="inforCheckboxLabel noColon label"><asp:Localize ID="localizeCaseSens" runat="server" Text="<%$ resources: localizeCaseSens.Text %>" /></label>
        </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td class="borderr" align="left">
            <input type="checkbox" id="chkLiteral" name="chkLiteral" onclick="QBAddCondition_Literal_Click()"  class="inforCheckbox"/>
            <label for="chkLiteral" class="inforCheckboxLabel noColon label"><asp:Localize ID="localizeUseAsLiteral" runat="server" Text="<%$ resources: localizeUseAsLiteral.Text %>" /></label>
